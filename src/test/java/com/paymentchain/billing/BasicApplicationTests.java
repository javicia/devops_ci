...
public class BasicApplicationTests extends AbstractIntegrationTest {
	...
	public void getAllInvoicesTest() throws Exception {
		...
		// Act & Assert
		mockMvc.perform(MockMvcRequestBuilders.get("/billing/v1").contentType("application/json"))
	...
	public void getInvoiceByIdTest() throws Exception {
		...
		// Act & Assert
		mockMvc.perform(MockMvcRequestBuilders.get("/billing/v1/{id}", defaultId).contentType("application/json"))
				.andExpect(MockMvcResultMatchers.status().isOk())
	...
	public void createInvoiceTest() throws Exception {
		...
		// Act & Assert
		mockMvc.perform(MockMvcRequestBuilders.post("/billing/v1").contentType("application/json")
	...
	public void givenInvalidInvoiceId_UpdateInvoice_NotFound() throws Exception {
		...
		// Act & Assert
		mockMvc.perform(MockMvcRequestBuilders.put(url).contentType("application/json")
	...
	public void deleteInvoiceTest() throws Exception {
		...
		// Act & Assert
		mockMvc.perform(MockMvcRequestBuilders.delete("/billing/v1/{id}", defaultId).contentType("application/json"))
				.andExpect(MockMvcResultMatchers.status().isOk());
	}
